...
class DateTimeMode(
    ...
    class MetaOapg:
        ...
        class properties:
            dateTimeMode = schemas.StrSchema
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        class value(
                            ...
                            @typing.overload
                            def __getitem__(self, name: typing_extensions.Literal["dateTimeMode"]) -> MetaOapg.properties.dateTimeMode: ...
                            
                            @typing.overload
                            def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                            
                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["dateTimeMode", ], str]):
                                # dict_instance[name] accessor
                                return super().__getitem__(name)
                            
                            
                            @typing.overload
                            def get_item_oapg(self, name: typing_extensions.Literal["dateTimeMode"]) -> typing.Union[MetaOapg.properties.dateTimeMode, schemas.Unset]: ...
                            
                            @typing.overload
                            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                            
                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dateTimeMode", ], str]):
                            ...
                            def __new__(
                                ...
                                *_args: typing.Union[dict, frozendict.frozendict, ],
                                dateTimeMode: typing.Union[MetaOapg.properties.dateTimeMode, list, tuple, schemas.Unset] = schemas.unset,
                                _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dateTimeMode", "_capabilities", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dateTimeMode", "_capabilities", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        dateTimeMode: typing.Union[MetaOapg.properties.dateTimeMode, str, schemas.Unset] = schemas.unset,
