...
from beoremote-cli.paths.beo_zone_zone_active_sources_primary_experience.get import GetPrimaryActiveSource


class ActiveSourcesApi(
    GetPrimaryActiveSource,
):
