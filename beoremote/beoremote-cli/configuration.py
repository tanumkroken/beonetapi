...
class Configuration(object):
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "http://beoproduct.local:8080" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("beoremote-cli")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://beoproduct.local:8080",
                'description': "product",
            }
        ]
