    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class mode(
                                ...
                                class properties:
                                    ...
                                    class range(
                                        ...
                                        def __new__(
                                            cls,
                                            *_args: typing.Union[dict, frozendict.frozendict, ],
                                            balance: typing.Union[MetaOapg.properties.balance, list, tuple, schemas.Unset] = schemas.unset,
                                            _configuration: typing.Optional[schemas.Configuration] = None,
                                            **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                                        ) -> 'range':
                                            return super().__new__(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "friendlyName", "digit", "balance", "loudness", "_capabilities", "_links", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "friendlyName", "digit", "balance", "loudness", "_capabilities", "_links", ], str]):
                    return super().get_item_oapg(name)
...
class GetSoundMode(BaseApi):
    ...
    def get_sound_mode(
        ...
        return self._get_sound_mode_oapg(
