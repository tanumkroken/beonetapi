...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class standby(
                ...
                class MetaOapg:
                    ...
                    class properties:
                            ...
                            class MetaOapg:
                                ...
                                class properties:
                                    ...
                                    class value(
                                        ...
                                        @typing.overload
                                        def __getitem__(self, name: typing_extensions.Literal["powerState"]) -> MetaOapg.properties.powerState: ...
                                        
                                        @typing.overload
                                        def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                                        
                                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["powerState", ], str]):
                                            # dict_instance[name] accessor
                                            return super().__getitem__(name)
                                        
                                        
                                        @typing.overload
                                        def get_item_oapg(self, name: typing_extensions.Literal["powerState"]) -> typing.Union[MetaOapg.properties.powerState, schemas.Unset]: ...
                                        
                                        @typing.overload
                                        def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                                        
                                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["powerState", ], str]):
                                        ...
                                        def __new__(
                                            ...
                                            *_args: typing.Union[dict, frozendict.frozendict, ],
                                            powerState: typing.Union[MetaOapg.properties.powerState, list, tuple, schemas.Unset] = schemas.unset,
                                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ...
                        class _links(
                            ...
                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["/relation/modify", "self", ], str]):
                                # dict_instance[name] accessor
                                return super().__getitem__(name)
                            ...
                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["/relation/modify", "self", ], str]):
                                return super().get_item_oapg(name)
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["powerState", "_capabilities", "_links", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["powerState", "_capabilities", "_links", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    powerState: typing.Union[MetaOapg.properties.powerState, str, schemas.Unset] = schemas.unset,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["standby"]) -> MetaOapg.properties.standby: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["standby", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["standby"]) -> typing.Union[MetaOapg.properties.standby, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["standby", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        standby: typing.Union[MetaOapg.properties.standby, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
class GetPowerState(BaseApi):
    ...
    def get_power_state(
        ...
        return self._get_power_state_oapg(
