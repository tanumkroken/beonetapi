<a name="__pageTop"></a>
# beoremote-cli.apis.tags.active_sources_api.ActiveSourcesApi

All URIs are relative to *http://beoproduct.local:8080*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_primary_active_source**](#get_primary_active_source) | **get** /BeoZone/Zone/ActiveSources/primaryExperience | Product Primary Active Source

# **get_primary_active_source**
<a name="get_primary_active_source"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} get_primary_active_source()

Product Primary Active Source

Poll the product primary active experince (source).
...
200 | [ApiResponseFor200](#get_primary_active_source.ApiResponseFor200) | OK

#### get_primary_active_source.ApiResponseFor200
...
**[activeSources](#activeSources)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
...
**[listenerList](#listenerList)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[listener](#listener)** | list, tuple,  | tuple,  |  | [optional] 
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[/relation/delete](#/relation/delete)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[listener.jid](#listener.jid)** | list, tuple,  | tuple,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[/relation/create](#/relation/create)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**primary** | str,  | str,  |  | [optional] 
**primaryJid** | str,  | str,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
