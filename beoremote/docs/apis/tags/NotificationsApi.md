<a name="__pageTop"></a>
# beoremote-cli.apis.tags.notifications_api.NotificationsApi

All URIs are relative to *http://beoproduct.local:8080*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_notifications**](#get_notifications) | **get** /BeoNotify/Notifications | Product Notifications

# **get_notifications**
<a name="get_notifications"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} get_notifications()

Product Notifications

The notification stream uses Long-polling to get real-time status updates.  Examples of data available in the notification stream: - Cover art - Metadata (song / artist / album / genre) - Source - Volume - Play state - Song progress - Friendly name - Standby status

### Example

```python
import beoremote-cli
from beoremote-cli.apis.tags import notifications_api
...
------------ | ------------- | ------------- | ------------- | -------------
**[notification](#notification)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
...
**primaryExperience** | [**PrimaryExperience**]({{complexTypePrefix}}PrimaryExperience.md) | [**PrimaryExperience**]({{complexTypePrefix}}PrimaryExperience.md) |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
