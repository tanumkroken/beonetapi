<a name="__pageTop"></a>
# beoremote-cli.apis.tags.terms_api.TermsApi

All URIs are relative to *http://beoproduct.local:8080*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_terms_and_conditions**](#get_terms_and_conditions) | **get** /BeoDevice/termsAndConditions | Product Terms

# **get_terms_and_conditions**
<a name="get_terms_and_conditions"></a>
> {str: (bool, date, datetime, dict, float, int, list, str, none_type)} get_terms_and_conditions()

Product Terms

Poll the product terms and conditions.

### Example

```python
import beoremote-cli
from beoremote-cli.apis.tags import terms_api
...
with beoremote-cli.ApiClient(configuration) as api_client:
    ...
    try:
        # Product Terms
        api_response = api_instance.get_terms_and_conditions()
        pprint(api_response)
    except beoremote-cli.ApiException as e:
        print("Exception when calling TermsApi->get_terms_and_conditions: %s\n" % e)
```
### Parameters
...
200 | [ApiResponseFor200](#get_terms_and_conditions.ApiResponseFor200) | OK

#### get_terms_and_conditions.ApiResponseFor200
...
**[termsAndConditions](#termsAndConditions)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
...
Key | Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | ------------- | -------------
**[acknowledgement](#acknowledgement)** | dict, frozendict.frozendict,  | frozendict.frozendict,  |  | [optional] 
**any_string_name** | dict, frozendict.frozendict, str, date, datetime, int, float, bool, decimal.Decimal, None, list, tuple, bytes, io.FileIO, io.BufferedReader | frozendict.frozendict, str, BoolClass, decimal.Decimal, NoneClass, tuple, bytes, FileIO | any string name can be used but the value must be the correct type | [optional]
